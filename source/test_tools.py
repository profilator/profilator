...
class TestTools(TestCase):
    ...
    def test_clean_string_one_link_not_equal(self):
        text = "Ananas banana kołysał https://youtu.be/6kS65TbKjeU?t=49 fajne"
        result = "Ananas banana kołysał fajnen"
        self.assertNotEqual(Tools.clean_string(text), result)

    def test_clean_string_one_link_with_slash(self):
        text = "Ananas banana kołysał https://youtu.be/6kS65TbKjeU?t=49/ fajne"
        result = "Ananas banana kołysał fajne"
        self.assertEqual(Tools.clean_string(text), result)

    def test_clean_string_two_links(self):
    ...
    def test_clean_string_new_line(self):
        text = "Ananas banana kołysał fajne\nhttps://youtu.be/6kS65TbKjeU?t=49"
        result = "Ananas banana kołysał fajne"
        self.assertEqual(Tools.clean_string(text), result)

    def test_clean_string_tag(self):
        text = "Ananas banana #mop_anioła kołysał fajne"
        result = "Ananas banana kołysał fajne"
        self.assertEqual(Tools.clean_string(text), result)

    def test_clean_string_start_and_end_tag(self):
        text = "#kokos Ananas banana kołysał fajne #pasta"
        result = "Ananas banana kołysał fajne"
        self.assertEqual(Tools.clean_string(text), result)

    def test_clean_string_mention(self):
        text = "Ananas banana @Andrzej_Duda kołysał fajne"
        result = "Ananas banana kołysał fajne"
        self.assertEqual(Tools.clean_string(text), result)

    def test_clean_string_start_and_end_mention(self):
        text = "@kokos Ananas banana kołysał fajne @pasta"
        result = "Ananas banana kołysał fajne"
        self.assertEqual(Tools.clean_string(text), result)

    def test_clean_string_with_all_trash(self):
